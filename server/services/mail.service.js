...
const signupMail = async (to, name) => {
  try {
    const message = {
      from: 'utor-mail@gmail.com',
      to,
      subject: 'Welcome to UTOR',
      html: `
        <p style="text-align: center;"><strong><span styl  e="font-size: 17px;">Thank you for joining us 😃</span></strong></p>
